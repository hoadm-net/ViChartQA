...
| Chất lượng nhãn multi-hop (đặc biệt trường `evidence`) thấp hơn `single_chart`, không có bước xác minh chéo độc lập để tự động bắt lỗi | Chất lượng nhãn multi-hop bị nghi ngờ khi review | Định nghĩa hop-type chặt + phép thử bỏ text ([docs/03](03-annotation-guidelines.md#hop-type-phạm-vi-bằng-chứng-mới)); Pod C rà soát mẫu định kỳ qua trang Soạn câu hỏi, dừng sprint để rà guideline nếu phát hiện lỗi lặp lại nhiều | Pod C |
