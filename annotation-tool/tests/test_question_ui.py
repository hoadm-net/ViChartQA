...
def test_render_copy_button_execution():
    # Kiểm tra gọi hàm render_copy_button với các loại chuỗi khác nhau không phát sinh exception
...
def test_render_doc_context_execution():
    # Kiểm tra render_doc_context gọi render_copy_button và word_count mượt mà
    mock_doc = type("Doc", (), {"body_text": "Đoạn văn bản mẫu kiểm thử copy text.", "charts": []})()
    render_doc_context(mock_doc, {})
